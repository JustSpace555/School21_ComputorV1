...
then
	...
	then
		...
		then curl https://download.java.net/java/GA/jdk14.0.1/664493ef4a6946b186ff29eb326336a2/7/GPL/openjdk-14.0.1_osx-x64_bin.tar.gz
		echo ""
		echo ""
		echo "Unarchiving file..."
...
then
	...
	if [[ "$OSTYPE" == "linux-gnu"* ]];
		then wget https://github.com/JetBrains/kotlin/releases/download/v1.4.10/kotlin-compiler-1.4.10.zip

	elif [[ "$OSTYPE" == "darwin"* ]];
		then curl https://github.com/JetBrains/kotlin/releases/download/v1.4.10/kotlin-compiler-1.4.10.zip
...
then
	...
	then
		curl https://github.com/libgdx/packr/releases/download/packr-2.7.0/packr-all-2.7.0.jar
